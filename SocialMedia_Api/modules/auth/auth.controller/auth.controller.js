...
export const signup = async(req,res)=>{
    ...
    if(user){
        ...
        const newUser = new userModel({email ,userName:username , name , password:hashPassword})
...
export const cofirmEmail =async (req,res)=>{
    try {
...
export const signin =async (req,res)=>{
    ...
    const user = await userModel.findOne({email})
    if (!user){
        res.json({mesasage:"invalid account"})
    }else{
        if(!user.confirmEmail){
        res.json({mesasage:"pls verify your email"})
            ...
            if(!match){
                ...
                res.json({mesasage:"wrong Password" })
            }else{
        ...
        res.json({mesasage:"success", token})
